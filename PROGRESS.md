...
- Same-order duplicate OrderPro item rows are collapsed before categorization/reconciliation, which addresses Costco OrderPro repeating identical item rows across exports or owners.
